...
class Prestamo:
    ...
    def add_prestamo(self):
        ...
        lector = input("Ingrese el lector: ")
    ...
    def buscar_prestamo(self):
        libro = input("Ingrese el libro a buscar: ")
        cursor = self.db.conexion.cursor()
    ...
    def modificar_prestamo(self):
        libro = input("Ingrese el libro a modificar: ")
        lector = input("Ingrese el nuevo lector: ")
        cursor = self.db.conexion.cursor()
        modificar_prestamo_query = ("UPDATE prestamos SET lector = %s WHERE libro = %s")
        prestamo_data = (lector, libro)
