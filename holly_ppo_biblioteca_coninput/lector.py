...
class Lector:
    ...
    def add_lector(self):
        ...
        apellidos = input("Ingrese los apellidos del lector: ")
        fecha_alta = input("Ingrese la fecha de alta del lector (YYYY-MM-DD): ")
        fecha_baja = input("Ingrese la fecha de baja del lector (YYYY-MM-DD): ")
    ...
    def buscar_lector(self):
        nombre = input("Ingrese el nombre del lector a buscar: ")
    ...
    def eliminar_lector(self):
        nombre = input("Ingrese el nombre del lector a eliminar: ")
    ...
    def modificar_lector(self):
        nombre = input("Ingrese el nombre del lector a modificar: ")
        apellidos = input("Ingrese los nuevos apellidos del lector: ")
        fecha_alta = input("Ingrese la nueva fecha de alta del lector (YYYY-MM-DD): ")
        fecha_baja = input("Ingrese la nueva fecha de baja del lector (YYYY-MM-DD): ")
